...
<body>
	<div>
		...
		<div class="row">
		  ...
		  <div class="col-sm-4">
		  	<div align="right">
					<span><img src="images/arrow1.png" width="40" height="35"><a href="signUp.php" style="color: #23C1CF;"> Create account?</a></span>
				</div>
				<div align="center">
					<h1 class="login-acc">Login</h1>
					<div >
						<p><h2 style="font-family:Segoe Print; font-weight: bold; color: #23C1CF;">To</h2></p>
						<p><h2 style="font-family:Segoe Print; font-weight: bold; color: #23C1CF;">Check</h2></p>
						<p><h2 style="font-family:Segoe Print; font-weight: bold; color: #23C1CF;">Your</h2></p>
						<p><h2 style="font-family:Segoe Print; font-weight: bold; color: #23C1CF;">Networth</h2></p>
					</div>
